...
- Solution URL: [Frontend Mentor](https://www.frontendmentor.io/solutions/mobile-first-approach-using-node-sass-flexbox-and-parcelbundler-neG9iLQiB)
- Live Site URL: [Huddle landing page](https://keen-lovelace-d9db90.netlify.app/)
